...
columns_of_interest = [
    'WSS_LMB','WSS','WSS_TE','WSS_LE','WSS_Bif',
    'WSS_Avg_Area','WSS_TE_Area','WSS_LE_Area','WSS_Bif_Area',
...
vars_to_plot = [
    'WSS_Bif','WSS_LE','WSS_TE','WSS','WSS_Bif_Area',
    'WSS_LE_Area','WSS_TE_Area','WSS_Avg_Area','Flow',
    'HMR','BMR/HMR','iFR','FFR','CFR','CFR/FFR'
]
