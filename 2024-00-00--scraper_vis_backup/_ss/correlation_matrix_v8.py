...
# Load the data
df_full = pd.read_csv('/Users/tejjolly/Documents/BioSimm/Simulations/Post_Processing/summary3.csv')
...
if pairgrid_switch:
    def scatter_cmap_marker(x, y, data=None, c=None, cmap=None, norm=None,
        ...
        cat_definitions = {
            ...
            "cat2": {"mask": (data['CFR'] > 2) & (data['FFR'] < 0.8), "marker": "o"},
            "cat3": {"mask": (data['CFR'] < 2) & (data['FFR'] > 0.8), "marker": "^"},
            "cat4": {"mask": (data['CFR'] < 2) & (data['FFR'] < 0.8), "marker": "v"},
        }
