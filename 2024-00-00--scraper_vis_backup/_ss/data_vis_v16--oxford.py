...
def make_smart_scatter(
        ...
        # ---- NEW ----
        show_colorbar=True,
        force_point_color=None,   # e.g. 'k' for black; if set, ignores color_col
):
    ...
    # Colorbar
    if show_colorbar and (force_point_color is None) and (first_scatter is not None):
...
if plot36:
    ...
    make_smart_scatter(
        data=df_filtered_third,
        x_col='HMR', y_col='P_d/P_a',
        color_col='HSR',  # can be anything valid; ignored if force_point_color is set
