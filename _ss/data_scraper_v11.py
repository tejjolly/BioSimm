...
for master_folder in ['master_ifr', 'master_ffr']:
    ...
    for item in os.listdir(master_path):
        ...
        if os.path.isdir(item_path) and item.startswith('Geometry_'):
            ...
            # NEW: MB/SB Bifur - read high_mb_wss_area.csv and high_sb_wss_area.csv
            wss_mb_area = ''
            wss_sb_area = ''
