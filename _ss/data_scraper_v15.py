...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 13 00:11:59 2025
...
# ----------------------------------------------------------------------------
# 6a) Create "discord" column based on (CFR>2) & (P_d/P_a>0.8)
# ----------------------------------------------------------------------------
for run in data:
    # Default
    run['discord'] = ''
    ...
    if cfr_val > 2 and ffr_val > 0.8:
        ...
        # If exactly cfr=2 or ffr=0.8, you can decide how to classify
