...
# --------------------------------------------------
# 6) EXAMPLE USAGE:
#    e.g. Plot "FFR (P_d/P_a) vs. HMR, colored by HSR"
#    for geometry combos that have multiple R_micro,
#    ignoring zero except the single special row.
# --------------------------------------------------
# df_plot_example = df[
#     df['HMR'].notna()
#     & df['P_d/P_a'].notna()
...
# ].copy()
#
# if not df_plot_example.empty:
#     boundaries_example = np.linspace(
#         df_plot_example['HSR'].min(),
#         df_plot_example['HSR'].max(),
#         6
#     )
#
#     make_smart_scatter(
#         data=df_plot_example,
#         x_col='HMR',
#         y_col='P_d/P_a',
#         color_col='HSR',
...
#         cmap_name='RdYlGn_r',
#         custom_boundaries=boundaries_example,
...
boundaries_third = np.linspace(.2, 1.2, 6)
