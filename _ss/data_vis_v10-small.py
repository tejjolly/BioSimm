...
summary_file = '/Users/tejjolly/Documents/BioSimm/Simulations/Post_Processing/summary2.csv'          # All runs
...
# -----------------------------
# 5) NOW GENERATE EACH PLOT
# -----------------------------
#
# We'll replicate your original filters and columns,
# but use `make_smart_scatter()` to apply the grouping logic.
