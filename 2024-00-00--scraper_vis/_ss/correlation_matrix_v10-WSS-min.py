...
df_full = df_full[df_full['Location'] != 'LCX'] # Delete LCX Data
...
columns_of_interest = [
    'WSS_LMB','WSS_TE_min','WSS_LE_min',
    'WSS_TE_Area_min','WSS_LE_Area_min','WSS_Bif_Area_min',
...
# Take log of all _min variables (if present)
min_cols = [col for col in df_subset.columns if '_min' in col]
for col in min_cols:
    print(f'col name log: {col}')
...
vars_to_plot = [
    'WSS_LE_min','WSS_TE_min','WSS_Bif_Area_min',
    'WSS_LE_Area_min','WSS_TE_Area_min','Flow',
