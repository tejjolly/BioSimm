...
df_raw = df_raw[mask]
df_raw['BMR/HMR'] *= df_raw['HMR']
df_raw.rename(columns={"BMR/HMR": "BMR"}, inplace=True)
...
feat_x, feat_y   = "BMR", "P_Loss_Coeff"        # axes you want to see
...
# ──────────────────────────────────────────────────────
# Feature setup
feat_x, feat_y, feat_z = "BMR", "P_Loss_Coeff", "HMR"
