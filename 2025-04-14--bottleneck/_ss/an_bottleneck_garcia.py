...
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, 500, T_mult=1, eta_min=1e-7)
...
plt.plot(range(num_epochs)[::20], lrs[::20])
plt.title('lr')
plt.show()
