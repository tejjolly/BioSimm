...
# -*- coding: utf-8 -*-
"""
Note: This Neural net is a 3-d bottleneck classifier
"""
"""
...
# ───────────────────────────────────────────────────────────
metrics = {
    "Neural Net": {  # Model A (3-D)
        "Precision": {0: (0.940, 0.018), 1: (0.893, 0.101), 2: (0.971, 0.057), 3: (0.906, 0.087)},
        "Sensitivity": {0: (0.940, 0.037), 1: (0.890, 0.077), 2: (0.927, 0.090), 3: (0.895, 0.065)},
        "Specificity": {0: (0.960, 0.013), 1: (0.956, 0.045), 2: (0.995, 0.009), 3: (0.969, 0.030)}
    },
    "Linear Classifier": {  # Model B (4-Way Linear Classifier)
